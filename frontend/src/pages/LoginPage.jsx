            ...
            <div className="bg-white rounded-3xl shadow-xl w-full max-w-4xl overflow-hidden flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12">
                    ...
                    <a
                        ...
                        className="w-full h-12 flex items-center justify-center gap-3 border-2 border-slate-200 rounded-xl text-slate-700 font-semibold hover:bg-slate-50 transition-colors"
                    >
                ...
                <div className="hidden md:block w-1/2 bg-indigo-600 relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center p-12 text-white z-10">
                        <h3 className="text-3xl font-bold mb-6">Smart Parking Management</h3>
                        <p className="text-indigo-100 text-lg leading-relaxed">
                            Experience the future of valet parking. Efficient, secure, and seamless management for modern hotels and venues.
                        </p>
                    </div>
                    {/* Abstract Circles */}
